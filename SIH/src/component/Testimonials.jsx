...
const TestimonialsSection = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center px-6 py-12 md:px-20 bg-white">
      ...
      {/* Subtext */}
      <p className="max-w-3xl text-gray-600 text-base md:text-lg leading-relaxed mb-12 text-center">
      ...
      {/* Cards */}
      <div className="w-full max-w-6xl bg-gray-50 rounded-xl shadow-sm p-8">
